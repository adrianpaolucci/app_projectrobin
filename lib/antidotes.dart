...
class AntidotesState extends State<Antidotes> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < allDrugs[intIndex14].length; i++) {
      Widget iOSswitch(var intIndex14) {
        return Padding(
          padding: EdgeInsets.only(
              right: data.size.width * 0.03),
          child: Switch(
              activeColor: Color(0xff39e600),
              value: allDrugBooleans[intIndex14][i],
              onChanged: (bool newValue) {
                setState(() {
                  ...
                  allDrugBooleans[intIndex14][i] = newValue;
                  if (boolCount == 0) {
                    clearAll();
                  }
                });
      ...
      var column = returnCell(context, intIndex14, i, iOSswitch(intIndex14));
